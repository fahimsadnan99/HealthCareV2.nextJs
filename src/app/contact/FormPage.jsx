            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 space-y-3 ">
              <div className="form-group ">
                ...
                <Field
                  name="fname"
                  type="text"
                  className="form-control text-lg py-1 px-4 w-[70%]  rounded-md ring-1 ring-black/25 outline-none"
              ...
              <div className="form-group col-span-2">
                ...
                <Field
                  ...
                  type="text"
                  as="textarea"
                  className="form-control text-lg py-1 px-4 w-[85%]  rounded-md ring-1 ring-black/25 outline-none"
                  id="exampleInputEmail1"
                  aria-describedby="emailHelp"
                />
              ...
              <div className="col-span-2  w-[85%] text-center">
